...
class CameraProperties {
    ...
    fun setCalibration(resWidth: Int, resHeight: Int, fovDiag: Rotation2d) {
        ...
        val camIntrinsics = Matrix(Nat.N3(), Nat.N3(), doubleArrayOf(
    ...
    companion object {
        ...
        init {
            PI4_PICAM2_480p.setCalibration(
                ...
                Matrix(Nat.N3(),
                    Nat.N3(), // intrinsic
                    doubleArrayOf(8204072694636.0, 0.0, 314.53659309737424,0.0, 481.6955284883231, 231.95042993880858,0.0, 0.0, 1.0)
                ),
            ...
            LL2_1280_720p.setCalibration(
                1280, 720,
                Matrix(Nat.N3(), Nat.N3(), doubleArrayOf( // intrinsic
